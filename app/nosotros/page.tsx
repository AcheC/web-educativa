...
export default function AboutUS() {
    return (
        <>
            {/* Hero */}
            <section className="bg-gradient-to-r from-[var(--color-primary-dark)] to-[var(--color-secondary)] text-[var(--color-surface)] py-20">
                <div className="max-w-6xl mx-auto px-6 grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
                    ...
                    <div className="flex items-center justify-center">
                        <Image src="/itsi.png" alt="Logo ITSI" width={300} height={300} className="rounded-full object-cover shadow-2xl"/>
                    </div>
                </div>
            </section>

            {/* Mission & Vision */}
            <section id="mission" className="light-section py-16 bg-white/75">
                ...
                <div className="max-w-6xl mx-auto px-6 grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
                    <AnimatedReveal>
                        <div>
                            ...
                            <a href="/nosotros/historia" className="inline-block mt-6 bg-[var(--color-primary)] hover:bg-[var(--color-primary-light)] text-white px-4 py-2 rounded-md">Leer la historia completa</a>
                        </div>
                    </AnimatedReveal>

                    <AnimatedReveal>
                        <div className="rounded-lg overflow-hidden shadow-lg">
                            <Image src="/ITSI-History.jpg" alt="Chone Histórico" width={450} height={255} className="w-full h-64 object-cover" />
                        </div>
                    </AnimatedReveal>
                </div>
            </section>
